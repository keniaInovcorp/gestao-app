...
<body>
    <div class="header">
        ...
        <div class="document-header-right">
            <div class="client-company-name">{{ $order->client->name ?? '' }}</div>
    ...
    <div class="client-details-section">
        <div class="client-details-header">
            <div class="client-details-left">
                <div class="client-detail-item"><strong>Cliente Nº:</strong> {{ $order->client->number ?? '' }}</div>
                <div class="client-detail-item"><strong>Contribuinte:</strong> {{ $order->client->tax_number ?? '' }}</div>
            </div>
            <div class="client-details-right">
                <div class="client-detail-item"><strong>Edição:</strong> 1</div>
                <div class="client-detail-item"><strong>de:</strong> {{ $order->order_date ? $order->order_date->format('d M Y') : '-' }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="summary-section">
        ...
        <div class="summary-right">
            @php
                $subtotal = $order->lines->sum(function($line) {
