                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <FormField v-slot="{ componentField }" name="photo" class="md:col-span-2">
                            <FormItem class="space-y-2">
                                ...
                                <FormDescription>
                                    Formatos aceites: JPEG, PNG, JPG, GIF (máx. 2MB)
                                </FormDescription>
                                <div v-if="photoPreview" class="mt-2">
                                    <img :src="photoPreview" alt="Preview" class="h-32 w-32 object-cover rounded" />
                                </div>
                                <FormMessage />
                            </FormItem>
                        </FormField>
...
const onSubmit = handleSubmit((values) => {
    ...
    inertiaForm.transform(() => formData).post('/products', {
