<template>
    <AuthenticatedLayout>
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold">Editar Função de Contacto</h1>
        </div>
...
const { handleSubmit } = useForm({
    ...
    initialValues: {
        ...
        status: props.contactFunction?.status || 'active',
    },
});
...
const onSubmit = handleSubmit((values) => {
    ...
    inertiaForm.put(`/contact-functions/${props.contactFunction.id}`);
});
</script>
