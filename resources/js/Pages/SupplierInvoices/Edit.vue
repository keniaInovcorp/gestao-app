            ...
            <div class="mb-6">
                ...
                <div class="bg-white rounded-lg shadow p-6" v-if="supplierInvoice.document">
                    ...
                    <form v-if="supplierInvoice.document" @submit.prevent="onSubmit" enctype="multipart/form-data" ref="formElement">
                        ...
                        <input type="hidden" name="send_payment_proof" :value="form.send_payment_proof" />
...
const onSubmit = () => {
    ...
    const hasFile = form.payment_proof instanceof File;
    ...
    if (hasFile) {
        ...
        form.transform(() => ({
            status: form.status,
            send_payment_proof: form.send_payment_proof || '0',
